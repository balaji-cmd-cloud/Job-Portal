    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(blank=True, help_text='Primary domain (e.g. IT, Finance, HR)', max_length=100)),
                ('location', models.CharField(blank=True, help_text='Current location (e.g. Bangalore, Mumbai)', max_length=100)),
